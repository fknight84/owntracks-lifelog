  ...
  fun <T> getDefaultValue(preferences: Preferences, property: KProperty<*>): T {
    return when (property) {
      ...
      Preferences::lifelogKnownWifis ->
          """[{"ssid":"knightHome5G","lat":35.863823,"lon":128.546645,"label":"중리동 내집"},{"ssid":"knights5G","lat":35.86407,"lon":128.54661,"label":"평리동 본가"},{"ssid":"KT_GiGA_5G_48F5","lat":35.89432,"lon":128.56335,"label":"엑소텍 대구지사"}]"""
